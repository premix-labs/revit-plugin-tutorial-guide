...
public class Command : IExternalCommand
{
    public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
        ...
        try
        {
            ...
            // จำลองการเขียนที่อาจเกิด Error เช่น ดึงชื่อพารามิเตอร์ที่ไม่มีอยู่จริง
            throw new InvalidOperationException("จำลองระบบค้นหาวัตถุล้มเหลวเนื่องจากไม่มีโมเดลอ้างอิง");
