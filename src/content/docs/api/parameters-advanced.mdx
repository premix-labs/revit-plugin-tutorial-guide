...
public void SetConcreteStrength(Document doc, Element element, string concreteGradeValue)
{
    ...
    {
        // ทำการเขียนข้อมูลค่าใหม่ลงไป (ต้องทำภายใต้ Transaction)
        using (Transaction trans = new Transaction(doc, "ตั้งค่ากำลังคอนกรีต"))
        {
            trans.Start();
